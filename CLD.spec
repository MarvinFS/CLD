...
# onnxruntime (Nemotron engine) needs no entry here: pyinstaller-hooks-contrib's
# hook-onnxruntime collects its DLLs from onnxruntime/capi.
...
coll = COLLECT(
    ...
    upx_exclude=[
        ...
        'vulkan-1.dll',
        # onnxruntime native runtime (Nemotron). UPX corrupts large native
        # ML runtimes - same crash class as ggml-vulkan.dll.
        'onnxruntime.dll',
