...
class Model:
    ...
    def __init__(self,
        ...
        :param use_gpu: Enable GPU acceleration (Vulkan/CUDA), default True
        :param gpu_device: GPU device index (0 = first GPU), default 0
        ...
        # GPU device selection (CLD modification)
    ...
    def _init_model(self) -> None:
        ...
        with utils.redirect_stderr(to=self.redirect_whispercpp_logs_to):
            # Use GPU-aware initialization if available (CLD modification)
            if hasattr(pw, 'whisper_init_from_file_with_params'):
                ...
                # Fallback to original function (no GPU device selection)
